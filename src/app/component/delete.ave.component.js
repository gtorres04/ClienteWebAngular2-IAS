...
var DeleteAveComponent = (function () {
    function DeleteAveComponent(location, genericService, route, router) {
     ...
     */
    DeleteAveComponent.prototype.eliminar = function () {
        var _this = this;
        this.deleted = true;
        this.ave.paises = this.paisesAdded;
        this.genericService.delete(this.ave, "ave").then(function (ave) { return _this.succes(ave); });
    };
    /**
